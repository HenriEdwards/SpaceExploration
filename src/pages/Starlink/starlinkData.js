const images = [
  { src: 'src/assets/starlink/sl1.png', 
    alt: 'spacex-starlink', 
    credit: 'https://satellitemap.space', 
    desc: "Check out this awesome interactive map of the Starlink satellite constellation."},
  { src: 'src/assets/starlink/sl3.jpg', 
    alt: 'spacex-starlink', 
    credit: 'https://x.com/ajtourville/status/1825649241391509979', 
    desc: "Starlink launch."},
  { src: 'src/assets/starlink/sl5.jpg', 
    alt: 'spacex-starlink', 
    credit: 'https://x.com/bluemoondance74/status/1828060208867787209', 
    desc: "Starlink launch."},
  { src: 'src/assets/starlink/sl2.jpg', 
    alt: 'spacex-starlink', 
    credit: 'https://x.com/rpg571/status/1828730206003106058/photo/1', 
    desc: "Successful SpaceX Falcon9 rocket launch carrying Starlink Group 8-6."},
  { src: 'src/assets/starlink/sl4.jpg', 
    alt: 'spacex-starlink', 
    credit: 'https://x.com/tweetsiphotos/status/1828707357922136500/photo/1', 
    desc: "B1062."},
  { src: 'src/assets/starlink/sl6.jpg', 
    alt: 'spacex-starlink', 
    credit: 'https://x.com/olexandr/status/1272708698541096960', 
    desc: "Stunning rainbow after recent Starlink-8 launch."},
  ]
